...
#define ATH12K_WSI_MAX_ADJACENT_DEVICES   2

struct ath12k_wsi_info {
	u32 device_idx;
	u32 num_adj_devices;
	u32 adj_device_idx[ATH12K_WSI_MAX_ADJACENT_DEVICES];
};
...
static inline
struct ath12k_base *ath12k_ag_to_ab(struct ath12k_hw_group *ag,
				    u8 device_id)
{
