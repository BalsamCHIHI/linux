...
/* host -> target Firmware  PPDU_STATS config message
 *
 * @details
 * The following field definitions describe the format of the HTT host
 * to target Firmware for PPDU_STATS_CFG msg.
...
/* @brief host -> target Firmware extended statistics retrieve
 *
 * @details
 * The following field definitions describe the format of the HTT host
 * to target Firmware extended stats retrieve message.
 ...
 *  - STATS_TYPE
 *    Bits 23:16
 *    Purpose: identifies which Firmware statistics to upload
