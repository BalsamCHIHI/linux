...
static inline
bool ath12k_hal_rx_h_last_msdu_wcn7850(struct hal_rx_desc *desc)
{
	return !!le16_get_bits(desc->u.wcn7850.msdu_end.info5,
...
static inline
u8 ath12k_hal_rx_h_l3pad_wcn7850(struct hal_rx_desc *desc)
{
	return le16_get_bits(desc->u.wcn7850.msdu_end.info5,
...
static inline
u32 ath12k_hal_rx_h_enctype_wcn7850(struct hal_rx_desc *desc)
{
...
static inline
u8 ath12k_hal_rx_h_decap_type_wcn7850(struct hal_rx_desc *desc)
{
...
static inline
u8 ath12k_hal_rx_h_mesh_ctl_present_wcn7850(struct hal_rx_desc *desc)
{
	return le32_get_bits(desc->u.wcn7850.msdu_end.info11,
...
static inline
bool ath12k_hal_rx_h_seq_ctrl_valid_wcn7850(struct hal_rx_desc *desc)
{
	return !!le32_get_bits(desc->u.wcn7850.mpdu_start.info4,
...
static inline
bool ath12k_hal_rx_h_fc_valid_wcn7850(struct hal_rx_desc *desc)
{
	return !!le32_get_bits(desc->u.wcn7850.mpdu_start.info4,
...
static inline
u16 ath12k_hal_rx_h_seq_no_wcn7850(struct hal_rx_desc *desc)
{
	return le32_get_bits(desc->u.wcn7850.mpdu_start.info4,
...
static inline
u16 ath12k_hal_rx_h_msdu_len_wcn7850(struct hal_rx_desc *desc)
{
	return le32_get_bits(desc->u.wcn7850.msdu_end.info10,
			     RX_MSDU_END_INFO10_MSDU_LENGTH);
}

static inline u8 ath12k_hal_rx_h_sgi_wcn7850(struct hal_rx_desc *desc)
{
...
static inline
u8 ath12k_hal_rx_h_rate_mcs_wcn7850(struct hal_rx_desc *desc)
{
	return le32_get_bits(desc->u.wcn7850.msdu_end.info12,
			     RX_MSDU_END_INFO12_RATE_MCS);
}

static inline u8 ath12k_hal_rx_h_rx_bw_wcn7850(struct hal_rx_desc *desc)
{
	return le32_get_bits(desc->u.wcn7850.msdu_end.info12,
			     RX_MSDU_END_INFO12_RECV_BW);
}

static inline u32 ath12k_hal_rx_h_freq_wcn7850(struct hal_rx_desc *desc)
{
	return __le32_to_cpu(desc->u.wcn7850.msdu_end.phy_meta_data);
}

static inline
u8 ath12k_hal_rx_h_pkt_type_wcn7850(struct hal_rx_desc *desc)
{
	return le32_get_bits(desc->u.wcn7850.msdu_end.info12,
			     RX_MSDU_END_INFO12_PKT_TYPE);
}

static inline u8 ath12k_hal_rx_h_nss_wcn7850(struct hal_rx_desc *desc)
{
	return le32_get_bits(desc->u.wcn7850.msdu_end.info12,
			     RX_MSDU_END_INFO12_MIMO_SS_BITMAP);
}

static inline u8 ath12k_hal_rx_h_tid_wcn7850(struct hal_rx_desc *desc)
{
	return le32_get_bits(desc->u.wcn7850.mpdu_start.info2,
...
static inline
u16 ath12k_hal_rx_h_peer_id_wcn7850(struct hal_rx_desc *desc)
{
	return __le16_to_cpu(desc->u.wcn7850.mpdu_start.sw_peer_id);
}

static inline
void ath12k_hal_rx_desc_end_tlv_copy_wcn7850(struct hal_rx_desc *fdesc,
					     struct hal_rx_desc *ldesc)
{
...
static inline void
ath12k_hal_rxdesc_set_msdu_len_wcn7850(struct hal_rx_desc *desc, u16 len)
{
...
static inline u8 *
ath12k_hal_rx_desc_get_msdu_payload_wcn7850(struct hal_rx_desc *desc)
{
	return &desc->u.wcn7850.msdu_payload[0];
}

static inline u32 ath12k_hal_rx_desc_get_mpdu_start_offset_wcn7850(void)
{
	return offsetof(struct hal_rx_desc_wcn7850, mpdu_start_tag);
}

static inline u32 ath12k_hal_rx_desc_get_msdu_end_offset_wcn7850(void)
{
	return offsetof(struct hal_rx_desc_wcn7850, msdu_end_tag);
}

static inline
bool ath12k_hal_rxdesc_mac_addr2_valid_wcn7850(struct hal_rx_desc *desc)
{
...
static inline u8 *
ath12k_hal_rxdesc_get_mpdu_start_addr2_wcn7850(struct hal_rx_desc *desc)
{
	return desc->u.wcn7850.mpdu_start.addr2;
}

static inline
bool ath12k_hal_rx_h_is_da_mcbc_wcn7850(struct hal_rx_desc *desc)
{
	return (ath12k_hal_rx_h_first_msdu_wcn7850(desc) &&
...
static inline u32 ath12k_hal_get_rx_desc_size_wcn7850(void)
{
	return sizeof(struct hal_rx_desc_wcn7850);
}

static inline
u8 ath12k_hal_rx_get_msdu_src_link_wcn7850(struct hal_rx_desc *desc)
{
	return 0;
}
