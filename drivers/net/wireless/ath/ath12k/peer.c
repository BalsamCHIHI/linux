...
void ath12k_peer_mlo_map_event(struct ath12k_base *ab, struct sk_buff *skb)
{
	...
	ml_peer_id = le32_get_bits(msg->info0,
	...
	mld_mac_h16 = le32_get_bits(msg->mac_addr_h16,
				    ATH12K_HTT_MLO_PEER_MAP_MAC_ADDR_H16);
	ath12k_dp_get_mac_addr(le32_to_cpu(msg->mac_addr_l32), mld_mac_h16, mld_addr);
...
void ath12k_peer_mlo_unmap_event(struct ath12k_base *ab, struct sk_buff *skb)
{
	...
	ml_peer_id = le32_get_bits(msg->info0, ATH12K_HTT_MLO_PEER_UNMAP_PEER_ID);
